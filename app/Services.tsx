...
const Services = (props: Props) => {
  return (
    <div className='w-10/12 mx-auto' id='services'>
        ...
        <div className='flex max-md:flex-wrap gap-7 justify-between'>
            <div className='d p-5 relativ overflow-hidden mt-5'>
                <h1 className='text-center mt-5'>Web/App Development</h1>
                <div className='flex justify-center mt-4'>
                    <MdDesignServices className='text-pink-600' size={28}/>
                </div>
                <p className='text-center mt-10 text-neutral-300'><span className=' text-xl font-bold '>Web/App</span> development creating compelling user interface</p>
            ...
            <div className='d p-5 relativ overflow-hidden  mt-5'>
                ...
                <p className='text-center mt-10 text-neutral-300'><span className=' text-xl font-bold '>You </span>will get a very organized, and understandable source which you can tweak later</p>
                <p className='text-center  mt-10 mb-7'><a href="" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>know more</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
            ...
            <div className='d p-5 relativ overflow-hidden  mt-5'>
                ...
                <p className='text-center mt-10 text-neutral-300'><span className=' text-xl font-bold '>Time</span> is the most valuable asset so I assure timely delivery</p>
                <p className='text-center  mt-10 mb-7'><a href="" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>know more</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
